...
class PostHandlerTest(BaseApiTestCase):
    ...
    def tearDown(self) -> None:
        ...
        try:
            os.remove(os.path.join(global_vars.upload_direcory, self.test_file_name))
...
class SpaceHandlerTest(BaseApiTestCase):
    ...
    def test_post_space_put_file(self):
        ...
        self.assertTrue(
            os.path.isfile(
                os.path.join(global_vars.upload_direcory, self.test_space, file_name)
            )
        )
    ...
    def _setup_space_file(self, author: str):
        ...
        # save to disk
        with open(
            os.path.join(global_vars.upload_direcory, self.test_space, filename), "wb"
        ) as fp:
