    ...
    return (
        <div className="px-4">
            <div className="group relative inline-block">
                ...
                <div className="absolute bottom-full left-1/2 w-[20rem] z-20 mb-1 -translate-x-1/2 rounded bg-white border px-4 py-[6px] text-sm font-semibold opacity-0 group-hover:opacity-100">
