    ...
    return (
        <li className={" m-1 border hover:border-ve-collab-orange rounded-xl"}>
            <Link scroll={false} href={"/content/" + browserCategorySlug + "/" + slug}>
                <div className={"mx-4 my-2 flex" + (browserSlug === slug ? " bg-ve-collab-orange-light rounded-xl" : "") }>
                    <Image className={"rounded-xl"} width={100} height={100} src={imgFilename} alt={""} ></Image>
                    <div className={"mx-4 flex items-center"}>
                        <div className={"h-12 w-56"}> {/* TODO this should not be fixed width, but instead force same width as parent to truncate text correctly depending on screen size*/}
