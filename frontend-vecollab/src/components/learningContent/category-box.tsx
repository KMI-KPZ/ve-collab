    ...
    return (
        <li>
            <Link scroll={false} href={"/content/" + slug}>
                <div className={"w-32 h-24 flex mx-2 px-0 hover:ring hover:ring-ve-collab-orange rounded-lg justify-center items-center " + (browserCategorySlug === slug ? " bg-ve-collab-orange-light " : " bg-white ")}>
                    <div>
