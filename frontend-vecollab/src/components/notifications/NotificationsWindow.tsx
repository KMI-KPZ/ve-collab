...
export default function NotificationsWindow({
    ...
    return (
        <div className="absolute z-50 left-[16px] sm:left-auto right-[16px] sm:right-0 w-auto sm:w-1/4 md:w-1/5 min-w-[15rem] top-24 min-h-[18rem] px-2 py-4 shadow rounded-l bg-white border">
