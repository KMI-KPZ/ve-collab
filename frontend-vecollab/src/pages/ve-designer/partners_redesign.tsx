...
import { MdArrowForward, MdArrowForwardIos, MdKeyboardDoubleArrowLeft, MdKeyboardDoubleArrowRight } from 'react-icons/md';
            ...
            <div className='flex flex-row divide-x gap-1'>
                ...
                {loading ? (
                    ...
                    <form className="w-full px-6 pt-1 max-w-screen-2xl flex flex-col gap-x-4">
                        ...
                        <div className='text-normale py-2 flex items-center text-slate-600'>
                            <MdArrowForwardIos size={15} /> Allgemein
                            <MdArrowForwardIos size={15} /> Partner
                        </div>
                        ...
                        <div className=''>
                                ...
                                <div
                                    className={
                                        'flex items-center font-bold text-2xl mb-2 relative h-14 mb-16'
                                    }
                                >
                                    <span>Wer ist am Projekt beteiligt?</span>
                                    {/* <span className='text-slate-300 italic mx-2' title='Dieser Schritt ist optional'>optional</span> */}
                                    {/* <Tooltip tooltipsText="Tipps für die Partnersuche findest du hier in den Selbstlernmaterialien …"> */}
                                        <Link
                                            ...
                                            title="Tipps für die Partnersuche findest du hier in den Selbstlernmaterialien …"
                                            className='rounded-full shadow hover:bg-gray-50 p-2 mx-2'
                                        >
                                            <PiBookOpenText size={25} color="#00748f" />
                                        </Link>
                                    {/* </Tooltip> */}
                                </div>
                            ...
                            {fieldsPartners.map((partner, index) => (
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        className="mx-4 p-2 bg-white rounded-3xl shadow hover:bg-slate-50"
                                    >
                                        <RxMinus size={20} />
                                    </button>
                                </div>
                            ...
                            <div className="flex  mt-4">
                                <button
                                    className="p-4 bg-white rounded-3xl shadow hover:bg-slate-50"
                                    type="button"
                                    onClick={() => {
                        ...
                        <div>
                            <div className={' font-bold text-xl mb-8 mt-10'}>
                                Extern Beteiligte
                            </div>
                        ...
                        <div className='my-3 border-t py-3 flex justify-between'>
                            ...
                            <div className="basis-20">
                                    <button
                                        type="button"
                                        className="flex justify-center items-center px-4 py-2 shadow bg-ve-collab-orange text-white rounded-full hover:bg-ve-collab-orange"
