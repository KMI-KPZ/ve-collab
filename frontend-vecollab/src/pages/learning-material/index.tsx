                ...
                <div className="relative min-h-[90vh]">
                    ...
                    <div className="absolute left-[90%] top-1/3 -translate-y-1/3 -translate-x-[90%]">
                        <div className="relative">
                            ...
                            >
                                <div className="h-36 w-36 absolute -z-10 -top-[3rem] -right-[5rem] rounded-full bg-white border border-ve-collab-blue flex items-center justify-center text-center text-ve-collab-blue cursor-pointer hover:text-ve-collab-orange hover:border-ve-collab-orange">
