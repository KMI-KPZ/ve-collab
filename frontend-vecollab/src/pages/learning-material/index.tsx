                ...
                <div className="relative min-h-[90vh]">
                    ...
                    <div className="absolute left-1/2 -translate-x-1/2">
                        <div className="relative">
                            <Link href={`/learning-material/topBubble/${props.mapping['topBubble'][0].text}`}>
                            ...
                            <Link href={`/learning-material/topBubble/${props.mapping['topBubble'][1].text}`}>
                            ...
                            <Link href={`/learning-material/topBubble/${props.mapping['topBubble'][2].text}`}>
                            ...
                            <Link href={`/learning-material/topBubble/${props.mapping['topBubble'][3].text}`}>
                            ...
                            <Link href="/learning-material/topBubble">
                    ...
                    <div className="absolute left-[10%] top-2/3 -translate-y-2/3 -translate-x-[10%]">
                        <div className="relative">
                            <Link
                                href={`/learning-material/leftBubble/${props.mapping['leftBubble'][0].text}`}
                            >
                            ...
                            <Link
                                href={`/learning-material/leftBubble/${props.mapping['leftBubble'][1].text}`}
                            >
                            ...
                            <Link
                                href={`/learning-material/leftBubble/${props.mapping['leftBubble'][2].text}`}
                            >
                            ...
                            <Link
                                href={`/learning-material/leftBubble/${props.mapping['leftBubble'][3].text}`}
                            >
                            ...
                            <Link
                                href={`/learning-material/leftBubble/${props.mapping['leftBubble'][4].text}`}
                            >
                            ...
                            <Link href="/learning-material/leftBubble">
                                <div className="h-72 w-72 rounded-full bg-ve-collab-blue flex justify-center items-center">
                                    <TbClipboardList
                                        size={150}
                                        className="text-white hover:text-ve-collab-orange"
                    ...
                    <div className="absolute left-[55%] top-[90%] -translate-y-[90%] -translate-x-[55%]">
                        <div className="relative">
                            <Link
                                href={`/learning-material/bottomBubble/${props.mapping['bottomBubble'][0].text}`}
                            >
                            ...
                            <Link
                                href={`/learning-material/bottomBubble/${props.mapping['bottomBubble'][1].text}`}
                            >
                            ...
                            <Link
                                href={`/learning-material/bottomBubble/${props.mapping['bottomBubble'][2].text}`}
                            >
                            ...
                            <Link href="/learning-material/bottomBubble">
                                <div className="h-72 w-72 rounded-full bg-ve-collab-blue flex justify-center items-center">
                                    <GiPuzzle
                                        size={150}
                                        className="text-white hover:text-ve-collab-orange"
                    ...
                    <div className="absolute left-[90%] top-1/3 -translate-y-1/3 -translate-x-[90%]">
                        <div className="relative">
                            <Link
                                href={`/learning-material/rightBubble/${props.mapping['rightBubble'][0].text}`}
                            >
                            ...
                            <Link
                                href={`/learning-material/rightBubble/${props.mapping['rightBubble'][1].text}`}
                            >
                            ...
                            <Link href="/learning-material/rightBubble">
                            <div className="h-72 w-72 rounded-full bg-ve-collab-blue flex justify-center items-center">
