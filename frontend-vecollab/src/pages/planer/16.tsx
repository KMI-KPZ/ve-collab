...
export default function BroadStages() {
    ...
    const addTask = (e: FormEvent, stepIndex: number) => {
        e.preventDefault()
        let copy = [...steps]
        copy[stepIndex].tasks = [...copy[stepIndex].tasks, { title: "", description: "", learning_goal: "", tools: ["", ""] }]
        setSteps(copy)
    }
            ...
            <div className="flex justify-between bg-pattern-left-blue-small bg-no-repeat">
                ...
                >
                    <div>
                        ...
                        <div className={"text-center mb-20"}>erweitere die Informationen zu jeder Etappe</div>
                        {steps.map((step, index) => (
                            <WhiteBox key={index}>
                                <div className="w-[60rem]">
                                    ...
                                    <div className="mt-4 flex">
                                        ...
                                        <div className="w-5/6">
                                            {step.tasks.map((task, taskIndex) => (
                                                <div key={taskIndex} className={"p-4 my-4 mx-2 bg-slate-200 rounded-3xl shadow-2xl"}>
                                                    ...
                                                    <div className={"mx-7 flex justify-end"}>
                                                        <button onClick={e => removeToolInputField(e, index, taskIndex)}><RxMinus size={20} /></button>
                                                        <button onClick={e => addToolInputField(e, index, taskIndex)}><RxPlus size={20} /></button>
                                                    </div>
                                                </div>
                                            ))}
                                        </div>
                                    ...
                                    <div className={"mx-7 flex justify-end"}>
                                        <button onClick={e => removeTask(e, index)}><RxMinus size={20} /></button>
                                        <button onClick={e => addTask(e, index)}><RxPlus size={20} /></button>
                                    </div>
                                </div>
                            </WhiteBox>
                        ))}
