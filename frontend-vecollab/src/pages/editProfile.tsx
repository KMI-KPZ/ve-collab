                                ...
                                <form onSubmit={updateProfileData}>
                                    ...
                                    <div className={"my-5"}>
                                        ...
                                        {veInterests.map((interest, index) => (
                                            <input key={index} className={"border border-gray-500 rounded-lg px-2 py-1 mb-1 w-full"} type="text" placeholder={"In welchen Themengebieten willst du dich mit VE bewegen?"} value={interest} onChange={e => modifyVeInterests(index, e.target.value)} />
                                        ))}
